...
public data class ExploreRule(bookList: String? = null,
      name: String? = null,
      author: String? = null,
      intro: String? = null,
      kind: String? = null,
   ...
   public override operator fun equals(other: Any?): Boolean {
      if (this === other) {
         return true;
      } else if (other !is ExploreRule) {
         return false;
      } else {
         val var2: ExploreRule = other as ExploreRule;
         if (!(this.getBookList() == (other as ExploreRule).getBookList())) {
            return false;
