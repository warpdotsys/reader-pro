...
public final val okHttpClient: OkHttpClient by LazyKt.lazy(SyntheticFunction0.INSTANCE)
   public final get() {
      return okHttpClient$delegate.getValue() as OkHttpClient;
   }

private final val proxyClientCache: ConcurrentHashMap<String, OkHttpClient> by LazyKt.lazy(SyntheticFunction0.INSTANCE)
   private final get() {
