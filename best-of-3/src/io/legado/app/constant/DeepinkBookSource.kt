...
public object DeepinkBookSource {
   public fun generate(name: String, url: String, md5: String) {
      ...
      val file: File = new File(
         "repo/${StringsKt.replace$default(StringsKt.replace$default(url, "https://", "", false, 4, null), "http://", "", false, 4, null)}.json"
      );
      System.out.println(Intrinsics.stringPlus("file path: ", file.getAbsoluteFile()));
      file.createNewFile();
