...
## Phase 16��UMD д�� + ��Լ���� + loginUi ����ҳ��

- **umdlib д·��**��WrapOutputStream��UmdBook.buildUmd���½� zlib chunk������/������
- **StreamReader** ���� jar��EOF ���� 0������ section ѭ��
- **UmdUtils**��stringToUnicodeBytes / compress / genRandomBytes
- **SmokeTest**��UMD write��read �ƽ����� + UmdFile ���ɣ�eader3-routes.txt ·����Լ
- **bookSourceDebug**����ʾ loginUrl/loginUi����������/��¼/�˳� API

## Phase 17��WebDAV � + �滻���� + �ı�Ŀ¼ + ��Լ��

- **WebDAV**��HEAD/LOCK/UNLOCK��PROPFIND displayname/getlastmodified��·����Խ����
- **restoreFromWebdav / listWebdavBackups** API
- **ContentProcessor**��regex:/pat/ �������ˡ�applyRules ֱ��
- **HtmlFormatter.formatKeepImg** ���� img
- **DefaultData** ���� classpath txtTocRule.json
- **SmokeTest**���滻����TXT ���¡�Cookie/ACache��TTS SSML��WebDAV ·��

## Phase 18��PDF/CBZ/LocalMedia + AnalyzeUrl ѡ�

- **PdfFile**��PDFTextStripper ��ҳȡ�ġ�Ԫ���ݡ�DPI/������Ⱦ JPEG ����
- **CbzFile**����Ȼ����ComicInfo.xml��getImage������
- **LocalMedia**��ͳһ PDF/CBZ ҳͼ
- **AnalyzeUrl**��,{method,body,headers,charset} ѡ����� POST��baseUrl��Cookie��loginCheckJs��retry
- **SmokeTest**��AnalyzeUrl ������CBZ ������PDF �ı�+��Ⱦ

## Phase 19��RSS ʵװ + ����ҳͼ��

- **RssSourceController**��CRUD �� sourceUrl �ϲ�/ɾ����getRssArticles/getRssContent ���� Rss ����
- **Rss**��RSS2/Atom��enclosure/media��sortUrl ���ࡢparseArticlesFromBody ����
- **getLocalBookImage**��PDF/CBZ ҳͼ����cover ֧�� bookUrl��LocalMedia
- **getRssSorts** API

## Phase 20��Debugger + ��Ȩ���Σ�

- **Debugger**������/����/����/Ŀ¼/������·��:: ++ -- ��λ��ʱ�����־
- **����**��md5(md5(pw+salt)+salt) + salt ���̣�addUser/resetPassword ���� jar
- **checkAuth**��accessToken ��ѯ/ͷ/Bearer��session
- **getInvalidBookSources**���� invalid ����Ŀ¼

## Phase 21��License RSA + WebDAV Basic��

- **EncoderUtils**��RSA �ֶμӽ��ܣ���˽Կ����genRsaPair
- **LicenseController**��generateKeys/import/activate/isLicenseValid/isHostValid/decrypt�������� host У��
- **WebDAV Basic**���û�+��������У�飻accessToken�����û� webdav home

## Phase 22��Mongo �ļ����� + ������֤�� + Զ�̼��

- **MongoBackup**��Mongo ���ȣ�ʧ��/δ����ʱ�ļ����䣻list/delete/backupAll
- **API**��listMongoBackups / deleteMongoBackup / backupAllToMongodb
- **EmailCodeStore**��6 λ��֤�� TTL��sendCodeToEmail / activate У��
- **RemoteLicenseClient**����ѡ POST �� r.htmake.com
- **clearInactiveUsers**���� last_login ����

## Phase 23����ʱ���� + SMTP��

- **ReaderJobs**��@Scheduled autoBackup / clearInactive / shelf tick
- **SmtpMailer**�������� SMTP ����֤�룻δ����ʱ�������� code
- **AppConfig/yml**��smtp*��autoBackup*��autoClear*
- **getSystemInfo**��jobs ״̬��smtpConfigured

## Phase 24����ܶ�ʱˢ�� + OpenAPI��

- **ShelfRefresh**�����û����ˢ�� latestChapter/totalChapterNum
- **ReaderJobs.shelfUpdateTick**���� shelfUpdateInteval ִ��
- **OpenAPI**��/reader3/openapi.json �� /reader3/apiDocs �� /reader3/apiRoutes.md
- **refreshShelfBooks** �ֶ�������ǰ�û�
