...
/* JADX INFO: loaded from: reader-pro-classes-3.2.14.jar:com/htmake/reader/api/controller/BookController$searchBookSourceSSE$3$bookSourceList$1.class */
@Metadata(mv = {1, 5, 1}, k = 3, xi = 48, d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n"}, d2 = {"<anonymous>", PackageDocumentBase.PREFIX_OPF, "it", "Lcom/fasterxml/jackson/databind/node/ObjectNode;"})
final class BookController$searchBookSourceSSE$3$bookSourceList$1 extends Lambda implements Function1<ObjectNode, Boolean> {
    final /* synthetic */ Ref.ObjectRef<String> $bookSourceGroup;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    BookController$searchBookSourceSSE$3$bookSourceList$1(Ref.ObjectRef<String> $bookSourceGroup) {
        super(1);
