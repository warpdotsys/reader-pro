...
/* JADX INFO: loaded from: reader-pro-classes-3.2.14.jar:com/htmake/reader/api/controller/WebdavController$1$7.class */
        ...
        try {
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (webdavController.webdavMove(routingContext, (Continuation) this) == coroutine_suspended) {
