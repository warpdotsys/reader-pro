...
/* JADX INFO: loaded from: reader-pro-classes-3.2.14.jar:com/htmake/reader/utils/IntTypeAdapter.class */
...
public final class IntTypeAdapter implements JsonSerializer<Integer>, JsonDeserializer<Integer> {
    ...
    public Integer m93deserialize(@NotNull JsonElement json, @Nullable Type typeOfT, @Nullable JsonDeserializationContext context) {
