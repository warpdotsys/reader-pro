...
/* JADX INFO: loaded from: reader-pro-classes-3.2.14.jar:com/htmake/reader/utils/RemoteWebview.class */
...
public final class RemoteWebview {
    ...
    /* JADX INFO: compiled from: RemoteWebview.kt */
    /* JADX INFO: loaded from: reader-pro-classes-3.2.14.jar:com/htmake/reader/utils/RemoteWebview$getStrResponse$1.class */
    ...
    public final Object getStrResponse(@Nullable String url, @Nullable String html, @Nullable String encode, @Nullable String tag, @Nullable Map<String, String> headerMap, @Nullable String sourceRegex, @Nullable String javaScript, @Nullable String proxy, boolean post, @Nullable String body, @NotNull String userNameSpace, @Nullable DebugLog debugLog, @NotNull Continuation<? super StrResponse> $completion) throws Exception {
        ...
        switch (anonymousClass1.label) {
            case 0:
                ...
                Ref.ObjectRef requestBody = new Ref.ObjectRef();
                ...
                Ref.ObjectRef remoteApi = new Ref.ObjectRef();
                ...
                objNewCallStrResponse = OkHttpUtilsKt.newCallStrResponse(HttpHelperKt.getProxyClient$default(null, debugLog, 1, null), 0, new RemoteWebview$getStrResponse$strResponse$1(remoteApi, requestBody), anonymousClass1);
