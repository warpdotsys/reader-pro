...
/* JADX INFO: loaded from: app-classes.jar:io/legado/app/help/http/CoroutinesCallAdapterFactory.class */
...
public final class CoroutinesCallAdapterFactory extends CallAdapter.Factory {
    ...
    /* JADX INFO: compiled from: CoroutinesCallAdapterFactory.kt */
    /* JADX INFO: loaded from: app-classes.jar:io/legado/app/help/http/CoroutinesCallAdapterFactory$Companion.class */
    ...
    /* JADX INFO: compiled from: CoroutinesCallAdapterFactory.kt */
    /* JADX INFO: loaded from: app-classes.jar:io/legado/app/help/http/CoroutinesCallAdapterFactory$BodyCallAdapter.class */
    ...
    private static final class BodyCallAdapter<T> implements CallAdapter<T, Deferred<? extends T>> {
        ...
        public Deferred<T> m178adapt(@NotNull final Call<T> call) {
            Intrinsics.checkNotNullParameter(call, "call");
            final Deferred<T> deferredCompletableDeferred$default = CompletableDeferredKt.CompletableDeferred$default((Job) null, 1, (Object) null);
            deferredCompletableDeferred$default.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: io.legado.app.help.http.CoroutinesCallAdapterFactory$BodyCallAdapter$adapt$1
                ...
                public final void invoke(@Nullable Throwable it) {
                    if (deferredCompletableDeferred$default.isCancelled()) {
                        call.cancel();
                    }
                }
            });
            call.enqueue(new Callback<T>() { // from class: io.legado.app.help.http.CoroutinesCallAdapterFactory$BodyCallAdapter$adapt$2
                public void onFailure(@NotNull Call<T> call2, @NotNull Throwable t) {
                    ...
                    deferredCompletableDeferred$default.completeExceptionally(t);
                }
                ...
                public void onResponse(@NotNull Call<T> call2, @NotNull Response<T> response) {
                    ...
                    if (response.isSuccessful()) {
                        CompletableDeferred<T> completableDeferred = deferredCompletableDeferred$default;
                        Object objBody = response.body();
                        Intrinsics.checkNotNull(objBody);
                        completableDeferred.complete(objBody);
                        return;
                    }
                    deferredCompletableDeferred$default.completeExceptionally(new HttpException(response));
                }
            });
    ...
    /* JADX INFO: compiled from: CoroutinesCallAdapterFactory.kt */
    /* JADX INFO: loaded from: app-classes.jar:io/legado/app/help/http/CoroutinesCallAdapterFactory$ResponseCallAdapter.class */
    ...
    private static final class ResponseCallAdapter<T> implements CallAdapter<T, Deferred<? extends Response<T>>> {
        ...
        @NotNull
        /* JADX INFO: renamed from: adapt, reason: merged with bridge method [inline-methods] */
        public Deferred<Response<T>> m179adapt(@NotNull final Call<T> call) {
            Intrinsics.checkNotNullParameter(call, "call");
            final Deferred<Response<T>> deferredCompletableDeferred$default = CompletableDeferredKt.CompletableDeferred$default((Job) null, 1, (Object) null);
            deferredCompletableDeferred$default.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: io.legado.app.help.http.CoroutinesCallAdapterFactory$ResponseCallAdapter$adapt$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
            ...
            call.enqueue(new Callback<T>() { // from class: io.legado.app.help.http.CoroutinesCallAdapterFactory$ResponseCallAdapter$adapt$2
                ...
                public void onResponse(@NotNull Call<T> call2, @NotNull Response<T> response) {
                    Intrinsics.checkNotNullParameter(call2, "call");
                    Intrinsics.checkNotNullParameter(response, "response");
                    deferredCompletableDeferred$default.complete(response);
                }
            });
            return deferredCompletableDeferred$default;
        }
