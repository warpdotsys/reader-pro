...
/* JADX INFO: loaded from: app-classes.jar:io/legado/app/model/analyzeRule/RuleData.class */
...
public final class RuleData implements RuleDataInterface {
    ...
    @NotNull
    private final Lazy variableMap = LazyKt.lazy(new Function0<HashMap<String, String>>() { // from class: io.legado.app.model.analyzeRule.RuleData$variableMap$2
        @NotNull
        /* JADX INFO: renamed from: invoke, reason: merged with bridge method [inline-methods] */
        public final HashMap<String, String> m249invoke() {
            return new HashMap<>();
        }
    });
