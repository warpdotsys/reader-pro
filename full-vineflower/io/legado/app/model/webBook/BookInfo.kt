...
public object BookInfo {
   ...
   public suspend fun analyzeBookInfo(
      ...
      if (body == null) {
         ...
         if (debugLog != null) {
            DebugLog.DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("└", var27), false, 4, null);
         }
         ...
         try {
            ...
            if (debugLog != null) {
               DebugLog.DefaultImpls.log$default(
                  debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("└", var24.getLocalizedMessage()), false, 4, null
               );
            }
         }
         ...
         try {
            ...
            if (debugLog != null) {
               DebugLog.DefaultImpls.log$default(
                  debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("└", book.getLatestChapterTitle()), false, 4, null
               );
            }
         } catch (var23: Exception) {
            if (debugLog != null) {
               DebugLog.DefaultImpls.log$default(
                  debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("└", var23.getLocalizedMessage()), false, 4, null
               );
            }
         }
         ...
         try {
            ...
            if (debugLog != null) {
               DebugLog.DefaultImpls.log$default(
                  debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("└", var22.getLocalizedMessage()), false, 4, null
               );
            }
         }
         ...
         try {
            ...
            if (debugLog != null) {
               DebugLog.DefaultImpls.log$default(
                  debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("└", var21.getLocalizedMessage()), false, 4, null
               );
            }
         }
