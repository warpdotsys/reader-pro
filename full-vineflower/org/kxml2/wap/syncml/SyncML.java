...
public abstract class SyncML {
   public static final String[] TAG_TABLE_0 = new String[]{
      "Add",
      "Alert",
      "Archive",
      "Atomic",
   ...
   public static final String[] TAG_TABLE_1 = new String[]{
      "Anchor",
      "EMI",
      "Format",
      "FreeID",
   ...
   public static final String[] TAG_TABLE_2_DM = new String[]{
      "AccessType",
      "ACL",
      "Add",
      "b64",
