      ...
      public void onMessage(@NotNull WebSocket webSocket, @NotNull ByteString bytes) {
         ...
         if (audioIndex != -1 && audioContentType) {
            try {
               ...
               TTSService.log.error("onMessage Error," + var6.getMessage(), (Throwable)var6);
            }
         }
      }
   };
   ...
   private synchronized WebSocket getOrCreateWs() {
      if (Objects.nonNull(this.ws)) {
         ...
         if (this.usingAzureApi) {
            url = "wss://eastus.api.speech.microsoft.com/cognitiveservices/websocket/v1?Retry-After=200&TrafficType=AzureDemo&Authorization=bearer undefined&X-ConnectionId="
               + Tools.getRandomId();
            origin = "https://azure.microsoft.com";
         } else {
            url = "wss://speech.platform.bing.com/consumer/speech/synthesize/readaloud/edge/v1?Retry-After=200&TrustedClientToken=6A5AA1D4EAFF4E9FB37E23D68491D6F4&ConnectionId="
               + Tools.getRandomId();
