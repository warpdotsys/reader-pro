...
public class LicenseController(coroutineContext: CoroutineContext) : BaseController(coroutineContext) {
   public final val backupFileNames: Array<String> by LazyKt.lazy(<unrepresentable>.INSTANCE)
      public final get() {
   ...
   private final val webClient: WebClient by LazyKt.lazy(<unrepresentable>.INSTANCE)
      private final get() {
