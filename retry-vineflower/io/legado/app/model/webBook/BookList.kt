...
public object BookList {
         ...
         label218: {
            ...
            switch ($continuation.label) {
               case 0:
                  ...
                  if (debugLog != null) {
                     DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("≡获取成功:", analyzeUrl.getRuleUrl()), false, 4, null);
                  }
                  ...
                  if (collections != null) {
                     ...
                     if (new Regex(collections).matches(baseUrl)) {
                        if (debugLog != null) {
                           DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), "≡链接为详情页", false, 4, null);
                        }
                  ...
                  if (debugLog != null) {
                     DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), "┌获取书籍列表", false, 4, null);
                  }
                  ...
                  if (var37.isEmpty()) {
                     ...
                     if (var43 == null || var43.length() == 0) {
                        if (debugLog != null) {
                           DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), "└列表为空,按详情页解析", false, 4, null);
                        }
   ...
   private suspend fun getSearchItem(
      ...
      if (log && debugLog != null) {
         DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("└", searchBook.getName()), false, 4, null);
      }
      ...
      if (searchBook.getName().length() <= 0) {
         ...
         if (log && debugLog != null) {
            DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("└", searchBook.getAuthor()), false, 4, null);
         }
         ...
         try {
            ...
            if (log && debugLog != null) {
               DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("└", searchBook.getKind()), false, 4, null);
            }
         } catch (var29: Exception) {
            if (log && debugLog != null) {
               DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("└", var29.getLocalizedMessage()), false, 4, null);
            }
         }
         ...
         try {
            ...
            if (log && debugLog != null) {
               DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("└", searchBook.getWordCount()), false, 4, null);
            }
         } catch (var28: Exception) {
            if (log && debugLog != null) {
               DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("└", var28.getLocalizedMessage()), false, 4, null);
            }
         }
         ...
         try {
            ...
            if (log && debugLog != null) {
               DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("└", searchBook.getLatestChapterTitle()), false, 4, null);
            }
         } catch (var27: Exception) {
            if (log && debugLog != null) {
               DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("└", var27.getLocalizedMessage()), false, 4, null);
            }
         }
         ...
         try {
            ...
            if (log && debugLog != null) {
               DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("└", searchBook.getIntro()), false, 4, null);
            }
         } catch (var26: Exception) {
            if (log && debugLog != null) {
               DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("└", var26.getLocalizedMessage()), false, 4, null);
            }
         }
         ...
         try {
            ...
            if (log && debugLog != null) {
               DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("└", searchBook.getCoverUrl()), false, 4, null);
            }
         ...
         JobKt.ensureActive(`$completion`.getContext());
         if (log && debugLog != null) {
            DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), "┌获取详情页链接", false, 4, null);
         }
         ...
         if (log && debugLog != null) {
            DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("└", searchBook.getBookUrl()), false, 4, null);
         }
