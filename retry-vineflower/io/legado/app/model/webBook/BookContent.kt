...
public object BookContent {
   public suspend fun analyzeContent(
      ...
      if (debugLog != null) {
         DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), "┌获取章节名称", false, 4, null);
      }

      if (debugLog != null) {
         DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("└", bookChapter.getTitle()), false, 4, null);
      }

      if (debugLog != null) {
         DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), "┌获取正文内容 (长度：${var33.length()})", false, 4, null);
      }
      ...
      if (var33.length() > 300) {
         if (debugLog != null) {
            ...
            DefaultImpls.log$default(debugLog, var57, var10002.append(var10003).toString(), false, 4, null);
         }
      } else if (debugLog != null) {
         DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("└\n", var33), false, 4, null);
      }
   ...
   private fun analyzeContent(
      ...
      if (nextUrlRule != null && nextUrlRule.length() != 0) {
         if (printLog && debugLog != null) {
            DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), "┌获取正文下一页链接", false, 4, null);
         }
