...
public final class Debugger implements DebugLog
{
    ...
    public void log(@Nullable final String sourceUrl, @Nullable final String msg, final boolean isHtml) {
        ...
        String printMsg = msg;
        if (isHtml) {
            printMsg = HtmlFormatter.format$default(HtmlFormatter.INSTANCE, msg, (Regex)null, 2, (Object)null);
        }
        final String time = this.debugTimeFormat.format(new Date(System.currentTimeMillis() - this.startTime));
    ...
    public final Object startDebug(@NotNull final WebBook webBook, @NotNull final String key, @NotNull final Continuation<? super Unit> $completion) {
        ...
        webBook.setDebugLogger((DebugLog)this);
        this.startTime = System.currentTimeMillis();
        if (StringExtensionsKt.isAbsUrl(key)) {
            ...
            final BookChapter chapter = new BookChapter((String)null, (String)null, false, (String)null, (String)null, 0, (String)null, (String)null, (Long)null, (Long)null, (String)null, (String)null, (String)null, 8191, (DefaultConstructorMarker)null);
            chapter.setTitle("\u8c03\u8bd5");
            chapter.setUrl(url);
        ...
        while (true) {
            switch (((Debugger$searchDebug.Debugger$searchDebug$1)$continuation).label) {
                case 0: {
                    ResultKt.throwOnFailure($result);
                    webBook.setDebugLogger((DebugLog)this);
                    DebugLog$DefaultImpls.log$default((DebugLog)this, (String)null, "\ufe3e\u5f00\u59cb\u89e3\u6790\u641c\u7d22\u9875", false, 5, (Object)null);
                    final Debugger debugger = this;
                    Object o = null;
                    Label_0250: {
                        try {
        ...
        while (true) {
            switch (((Debugger$infoDebug.Debugger$infoDebug$1)$continuation).label) {
                case 0: {
                    ResultKt.throwOnFailure($result);
                    webBook.setDebugLogger((DebugLog)this);
                    DebugLog$DefaultImpls.log$default((DebugLog)this, (String)null, "\ufe3e\u5f00\u59cb\u89e3\u6790\u8be6\u60c5\u9875", false, 5, (Object)null);
                    final Debugger debugger = this;
                    Object o2 = null;
                    Label_0249: {
                        try {
        ...
        while (true) {
            switch (((Debugger$tocDebug.Debugger$tocDebug$1)$continuation).label) {
                case 0: {
                    ResultKt.throwOnFailure($result);
                    webBook.setDebugLogger((DebugLog)this);
                    DebugLog$DefaultImpls.log$default((DebugLog)this, (String)null, "\ufe3e\u5f00\u59cb\u89e3\u6790\u76ee\u5f55\u9875", false, 5, (Object)null);
                    final Debugger debugger = this;
                    Object o = null;
                    Label_0261: {
                        try {
