...
import io.legado.app.data.entities.BaseSource$DefaultImpls;
    ...
    public final Object getArticles(@NotNull String sortName, @NotNull String sortUrl, @NotNull RssSource rssSource, final int page, @Nullable DebugLog debugLog, @NotNull final Continuation<? super Pair<? extends List<RssArticle>, String>> $completion) {
        ...
        switch (((Rss$getArticles.Rss$getArticles$1)$continuation).label) {
            case 0: {
                ...
                final AnalyzeUrl analyzeUrl = analyzeUrl2 = new AnalyzeUrl(sortUrl, null, Boxing.boxInt(page), null, null, null, (BaseSource)rssSource, (RuleDataInterface)ruleData, null, BaseSource$DefaultImpls.getHeaderMap$default((BaseSource)rssSource, false, 1, (Object)null), debugLog, 314, null);
                final String s = null;
    ...
    public final Object getContent(@NotNull RssArticle rssArticle, @NotNull String ruleContent, @NotNull RssSource rssSource, @Nullable DebugLog debugLog, @NotNull final Continuation<? super String> $completion) {
        ...
        switch (((Rss$getContent.Rss$getContent$1)$continuation).label) {
            case 0: {
                ResultKt.throwOnFailure($result);
                final AnalyzeUrl analyzeUrl2;
                final AnalyzeUrl analyzeUrl = analyzeUrl2 = new AnalyzeUrl(rssArticle.getLink(), null, null, null, null, rssArticle.getOrigin(), (BaseSource)rssSource, (RuleDataInterface)rssArticle, null, BaseSource$DefaultImpls.getHeaderMap$default((BaseSource)rssSource, false, 1, (Object)null), debugLog, 286, null);
                final String s = null;
                final String s2 = null;
                final boolean b = false;
                final Continuation continuation = $continuation;
        ...
        final String body = ((StrResponse)strResponseAwait$default).getBody();
        final AnalyzeRule analyzeRule = new AnalyzeRule((RuleDataInterface)rssArticle, (BaseSource)rssSource, debugLog);
