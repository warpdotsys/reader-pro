...
public final class BookInfo
{
    ...
    public final Object analyzeBookInfo(@NotNull final Book book, @Nullable final String body, @NotNull final BookSource bookSource, @NotNull final String baseUrl, @NotNull final String redirectUrl, final boolean canReName, @Nullable final DebugLog debugLog, @NotNull final Continuation<? super Unit> $completion) throws Exception {
        ...
        if (debugLog != null) {
            DebugLog$DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("\u2261\u83b7\u53d6\u6210\u529f:", (Object)baseUrl), false, 4, (Object)null);
        }
    ...
    public final Object analyzeBookInfo(@NotNull final Book book, @Nullable final String body, @NotNull final AnalyzeRule analyzeRule, @NotNull final BookSource bookSource, @NotNull final String baseUrl, @NotNull final String redirectUrl, final boolean canReName, @Nullable final DebugLog debugLog, @NotNull final Continuation<? super Unit> $completion) throws Exception {
        ...
        if (debugLog != null) {
            DebugLog$DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("\u2514", (Object)it), false, 4, (Object)null);
        ...
        try {
            ...
            if (debugLog != null) {
                DebugLog$DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("\u2514", (Object)book.getKind()), false, 4, (Object)null);
        ...
        try {
            ...
            if (debugLog != null) {
                DebugLog$DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("\u2514", (Object)book.getWordCount()), false, 4, (Object)null);
        ...
        try {
            ...
            if (debugLog != null) {
                DebugLog$DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("\u2514", (Object)book.getLatestChapterTitle()), false, 4, (Object)null);
        ...
        try {
            ...
            if (debugLog != null) {
                DebugLog$DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("\u2514", (Object)book.getIntro()), false, 4, (Object)null);
        ...
        try {
            ...
            if (debugLog != null) {
                DebugLog$DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("\u2514", (Object)book.getCoverUrl()), false, 4, (Object)null);
        ...
        if (debugLog == null) {
            ...
            DebugLog$DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("\u2514", (Object)book.getTocUrl()), false, 4, (Object)null);
