...
import io.legado.app.adapters.ReaderAdapterInterface$DefaultImpls;
...
public final class AnalyzeUrl implements JsExtensions
{
    ...
    private final void analyzeFields(final String fieldsTxt) {
        ...
        final String[] queryS = splitNotBlank = StringExtensionsKt.splitNotBlank(fieldsTxt, new String[] { "&" });
        int i = 0;
        while (i < splitNotBlank.length) {
            final String query = splitNotBlank[i];
            ++i;
            final String[] queryM = StringExtensionsKt.splitNotBlank(query, new String[] { "=" });
    ...
    public final Object evalJS(@NotNull final String jsStr, @Nullable final Object result) {
        ...
        final String s = "book";
        final RuleDataInterface ruleData = this.ruleData;
        map.put(s, (ruleData instanceof Book) ? ruleData : null);
    ...
    public final String get(@NotNull final String key) {
        ...
        if (Intrinsics.areEqual((Object)key, (Object)"bookName")) {
            final RuleDataInterface ruleData = this.ruleData;
            final Book book = (ruleData instanceof Book) ? ruleData : null;
            if (book != null) {
                final Book it = book;
                final int n = 0;
                return it.getName();
                ...
                Label_0622: {
                    ...
                    Label_0619: {
                        ...
                        Label_0456: {
                            ...
                            switch (((AnalyzeUrl$getStrResponseAwait.AnalyzeUrl$getStrResponseAwait$1)$continuation).label) {
                                case 0: {
                                    ...
                                    if (this.getType() != null) {
                                        ...
                                        ((AnalyzeUrl$getStrResponseAwait.AnalyzeUrl$getStrResponseAwait$1)$continuation).L$0 = l$0;
                                        ...
                                        if (this.useWebView && useWebView) {
                                            if (WhenMappings.$EnumSwitchMapping$0[this.method.ordinal()] == 2) {
                                                ...
                                                final BaseSource source2 = this.source;
                                                final String s = (source2 == null) ? null : source2.getKey();
                                                final String webJs = this.webJs;
                                                final String s2 = (webJs == null) ? jsStr : webJs;
                                                ...
                                                final String s9 = body;
                                                final String s10 = userNameSpace;
                                                ...
                                                if ((strResponseByRemoteWebview$default = ReaderAdapterInterface$DefaultImpls.getStrResponseByRemoteWebview$default(adapter, s3, s4, s5, s6, map, sourceRegex, s7, s8, b, s9, s10, debugLog2, continuation, n, o)) == coroutine_SUSPENDED) {
                                                    return coroutine_SUSPENDED;
                                                }
                                                break Label_0456;
                                            }
                                                ...
                                                final BaseSource source3 = this.source;
                                                final String s11 = (source3 == null) ? null : source3.getKey();
                                                final String webJs2 = this.webJs;
                                                final String s12 = (webJs2 == null) ? jsStr : webJs2;
                                                ...
                                                final String s20 = userNameSpace2;
                                                ...
                                                if ((strResponseByRemoteWebview$default2 = ReaderAdapterInterface$DefaultImpls.getStrResponseByRemoteWebview$default(adapter2, s13, s14, s15, s16, map2, sourceRegex, s17, s18, b2, s19, s20, debugLog4, continuation2, n2, o2)) == coroutine_SUSPENDED) {
                                                    return coroutine_SUSPENDED;
                                                }
                                                break Label_0619;
                                            }
                                ...
                                case 1: {
                                    ...
                                    l$0 = (String)((AnalyzeUrl$getStrResponseAwait.AnalyzeUrl$getStrResponseAwait$1)$continuation).L$0;
                                    ResultKt.throwOnFailure($result);
                            ...
                            return new StrResponse(l$0, instance.byteToHexString((byte[])byteArrayAwait));
                        }
    ...
    public final Object getResponseAwait(@NotNull final Continuation<? super Response> $completion) {
        ...
        switch (((AnalyzeUrl$getResponseAwait.AnalyzeUrl$getResponseAwait$1)$continuation).label) {
            case 0: {
                ...
                final OkHttpClient proxyClient$default = HttpHelperKt.getProxyClient$default(this.proxy, (DebugLog)null, 2, (Object)null);
                final int retry = this.retry;
    ...
    public final Object upload(@NotNull final String fileName, @NotNull final Object file, @NotNull final String contentType, @NotNull final Continuation<? super StrResponse> $completion) {
        return OkHttpUtilsKt.newCallStrResponse(HttpHelperKt.getProxyClient$default(this.proxy, (DebugLog)null, 2, (Object)null), this.retry, (Function1<? super Request$Builder, Unit>)new AnalyzeUrl$upload.AnalyzeUrl$upload$2(this, fileName, file, contentType), $completion);
    }
