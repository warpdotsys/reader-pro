...
public final class AnalyzeRule implements JsExtensions
{
    ...
    public final BaseBook getBook() {
        ...
        return (ruleData instanceof BaseBook) ? ruleData : null;
    }
    ...
    public final Object getElement(@NotNull final String ruleStr) {
        ...
        if (content != null && !ruleList.isEmpty()) {
            ...
            for (final SourceRule sourceRule : ruleList) {
                ...
                final int n = 0;
                result = switch (WhenMappings.$EnumSwitchMapping$0[sourceRule.getMode$reader_pro().ordinal()]) {
                    case 5 -> AnalyzeByRegex.getElement$default(AnalyzeByRegex.INSTANCE, String.valueOf(result), StringExtensionsKt.splitNotBlank(sourceRule.getRule$reader_pro(), new String[] { "&&" }), 0, 4, (Object)null);
                    case 1 -> this.evalJS(sourceRule.getRule$reader_pro(), it);
    ...
    public final List<Object> getElements(@NotNull final String ruleStr) {
        ...
        if (content != null && !ruleList.isEmpty()) {
            ...
            for (final SourceRule sourceRule : ruleList) {
                ...
                final int n = 0;
                result = switch (WhenMappings.$EnumSwitchMapping$0[sourceRule.getMode$reader_pro().ordinal()]) {
                    case 5 -> AnalyzeByRegex.getElements$default(AnalyzeByRegex.INSTANCE, String.valueOf(result), StringExtensionsKt.splitNotBlank(sourceRule.getRule$reader_pro(), new String[] { "&&" }), 0, 4, (Object)null);
                    case 1 -> this.evalJS(sourceRule.getRule$reader_pro(), result);
    ...
    public final void reGetBook() {
        ...
        final BookSource bookSource = (source instanceof BookSource) ? source : null;
        final BaseBook book2 = this.getBook();
        final Book book = (book2 instanceof Book) ? book2 : null;
