...
public class YueduApi extends RestVerticle
{
    ...
    private final Object getSystemInfo(final RoutingContext context, final Continuation<? super ReturnData> $completion) {
        ...
        return ReturnData.setData$default(returnData, (Object)MapsKt.mapOf(new Pair[] { TuplesKt.to((Object)"fonts", (Object)systemFont), TuplesKt.to((Object)"freeMemory", (Object)freeMemory), TuplesKt.to((Object)"totalMemory", (Object)totalMemory), TuplesKt.to((Object)"maxMemory", (Object)maxMemory), TuplesKt.to((Object)"dayRegisterUser", (Object)Boxing.boxInt(dayRegisterUser.element)), TuplesKt.to((Object)"dayLoginUser", (Object)Boxing.boxInt(dayLoginUser.element)), TuplesKt.to((Object)"sevenDayRegisterUser", (Object)Boxing.boxInt(sevenDayRegisterUser.element)), TuplesKt.to((Object)"sevenDayLoginUser", (Object)Boxing.boxInt(sevenDayLoginUser.element)), TuplesKt.to((Object)"monthRegisterUser", (Object)Boxing.boxInt(monthRegisterUser.element)), TuplesKt.to((Object)"monthLoginUser", (Object)Boxing.boxInt(monthLoginUser.element)), TuplesKt.to((Object)"keepUser", (Object)Boxing.boxInt(keepUser.element)) }), (String)null, 2, (Object)null);
    }
