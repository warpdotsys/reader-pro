...
import com.htmake.reader.db.DB$Companion;
...
public interface CURD<T>
{
    ...
    public static final class DefaultImpls
    {
        ...
        public static <T> Object list(@NotNull CURD<T> this, @NotNull RoutingContext context, @NotNull final Continuation<? super ReturnData> $completion) {
            ...
            JsonArray list = DB$Companion.table$default(DB.Companion, userNameSpace, this.getTableName(), (String)null, 4, (Object)null).readAll();
        ...
        public static <T> Object save(@NotNull CURD<T> this, @NotNull RoutingContext context, @NotNull final Continuation<? super ReturnData> $completion) {
            ...
            final String userNameSpace = this.getUserNS(context);
            final DB db = DB$Companion.table$default(DB.Companion, userNameSpace, this.getTableName(), (String)null, 4, (Object)null);
            final ReturnData result = this.beforeSave(entity, db);
            if (result != null) {
                return result;
            }
            db.save(entity, (Function3)new CURD$save.CURD$save$2(this), (Function2)new CURD$save.CURD$save$3(this));
        ...
        public static <T> Object saveMulti(@NotNull CURD<T> this, @NotNull RoutingContext context, @NotNull final Continuation<? super ReturnData> $completion) {
            ...
            db.saveMulti(itemList, (Function3)new CURD$saveMulti.CURD$saveMulti$2(this), (Function2)new CURD$saveMulti.CURD$saveMulti$3(this));
            return ReturnData.setData$default(returnData, (Object)"", (String)null, 2, (Object)null);
        }
