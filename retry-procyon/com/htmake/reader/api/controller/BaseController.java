...
public class BaseController implements CoroutineScope
{
    ...
    public BaseController(@NotNull final CoroutineContext coroutineContext) {
        ...
        final Object bean = SpringContextUtils.getBean("appConfig", (Class)AppConfig.class);
        Intrinsics.checkNotNullExpressionValue(bean, "getBean(\"appConfig\", AppConfig::class.java)");
        this.appConfig = (AppConfig)bean;
        final Object bean2 = SpringContextUtils.getBean((Class)Environment.class);
                        ...
                        while (true) {
                            ...
                            if (regenerateToken) {
                                ...
                                if (user.getToken_map() != null) {
                                    final Map token_map = user.getToken_map();
                    ...
                    if (tmp.size() >= 2) {
                        ...
                        if (existedUser != null && token.length() > 0) {
                            ...
                            if (!isLogin && existedUser.getToken_map() != null) {
                                final Map token_map = existedUser.getToken_map();
