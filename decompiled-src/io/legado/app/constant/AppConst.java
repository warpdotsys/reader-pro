 ...
 *  com.script.javascript.RhinoScriptEngine
 *  kotlin.Lazy
 *  kotlin.LazyKt
 *  kotlin.Metadata
...
public final class AppConst {
    ...
    @NotNull
    private static final Lazy userAgent$delegate = LazyKt.lazy((Function0)userAgent.2.INSTANCE);
    @NotNull
    private static final Lazy SCRIPT_ENGINE$delegate = LazyKt.lazy((Function0)SCRIPT_ENGINE.2.INSTANCE);
    @NotNull
    private static final Lazy TIME_FORMAT$delegate = LazyKt.lazy((Function0)TIME_FORMAT.2.INSTANCE);
    @NotNull
    private static final Lazy timeFormat$delegate = LazyKt.lazy((Function0)timeFormat.2.INSTANCE);
    @NotNull
    private static final Lazy dateFormat$delegate = LazyKt.lazy((Function0)dateFormat.2.INSTANCE);
    @NotNull
    private static final Lazy fileNameFormat$delegate = LazyKt.lazy((Function0)fileNameFormat.2.INSTANCE);
    @NotNull
    private static final Lazy keyboardToolChars$delegate = LazyKt.lazy((Function0)keyboardToolChars.2.INSTANCE);
    ...
    public final RhinoScriptEngine getSCRIPT_ENGINE() {
        Lazy lazy = SCRIPT_ENGINE$delegate;
        boolean bl = false;
        return (RhinoScriptEngine)lazy.getValue();
    }

    @NotNull
    public final SimpleDateFormat getTIME_FORMAT() {
        Lazy lazy = TIME_FORMAT$delegate;
        boolean bl = false;
    ...
    public final SimpleDateFormat getFileNameFormat() {
        Lazy lazy = fileNameFormat$delegate;
        boolean bl = false;
        return (SimpleDateFormat)lazy.getValue();
    }
    ...
    public final List<String> getKeyboardToolChars() {
        Lazy lazy = keyboardToolChars$delegate;
        boolean bl = false;
