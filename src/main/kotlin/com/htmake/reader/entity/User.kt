...
data class User(
    ...
    var enable_local_store: Boolean = false,
    var enable_book_source: Boolean = true,
    var enable_rss_source: Boolean = true,
    var book_source_limit: Int = 100,
    var book_limit: Int = 200,
)
