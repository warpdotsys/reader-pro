            ...
            if (eventType == XmlPullParser.START_TAG) {
                when {
                    ...
                    xmlPullParser.name.equals(RSS_ITEM_ENCLOSURE, true) ->
                        if (insideItem) {
                            val type = xmlPullParser.getAttributeValue(null, RSS_ITEM_TYPE)
                            if (type != null && type.contains("image/")) {
                                currentArticle.image =
                                    xmlPullParser.getAttributeValue(null, RSS_ITEM_URL)
                            }
                        }
                    xmlPullParser.name.equals(RSS_ITEM_DESCRIPTION, true) ->
                        if (insideItem) {
                    ...
                    xmlPullParser.name.equals(RSS_ITEM_PUB_DATE, true) ->
                        if (insideItem) {
