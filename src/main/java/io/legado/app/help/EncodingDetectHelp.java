...
class BytesEncodingDetect extends Encoding {
   ...
   void initialize_frequencies() {
      ...
      for(int var3 = 125; var3 >= 0; --var3) {
         for(int j = 190; j >= 0; --j) {
            this.GBKFreq[var3][j] = 0;
         }
      }

      for(int var4 = 93; var4 >= 0; --var4) {
         for(int j = 157; j >= 0; --j) {
            this.Big5Freq[var4][j] = 0;
         }
      }

      for(int var5 = 125; var5 >= 0; --var5) {
         for(int j = 190; j >= 0; --j) {
            this.Big5PFreq[var5][j] = 0;
         }
      }

      for(int var6 = 93; var6 >= 0; --var6) {
         for(int j = 93; j >= 0; --j) {
            this.EUC_TWFreq[var6][j] = 0;
         }
      }

      for(int var7 = 93; var7 >= 0; --var7) {
         for(int j = 93; j >= 0; --j) {
            this.JPFreq[var7][j] = 0;
         }
      }
