...
public enum VoiceEnum
{
    ...
    private VoiceEnum(final String shortName, final String gender, final String locale) {
    ...
    public static VoiceEnum fromSortName(final String shortName) {
        for (final VoiceEnum eVoiceEnum : values()) {
