...
{
    @NotNull
    public static final appCtx INSTANCE;
    @NotNull
    ...
    public final String getCacheDir() {
        return (String)appCtx.cacheDir$delegate.getValue();
    }
    
    static {
        INSTANCE = new appCtx();
        cacheDir$delegate = LazyKt.lazy((Function0)appCtx$cacheDir.appCtx$cacheDir$2.INSTANCE);
    }
}
