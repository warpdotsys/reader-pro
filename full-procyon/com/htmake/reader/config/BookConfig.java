...
public final class BookConfig
{
    ...
    @NotNull
    private static final String javascriptVersion;
    @NotNull
    ...
    public final String getJavascriptVersion() {
        return BookConfig.javascriptVersion;
    }
    
    @NotNull
    public final String getEpubInjectJavascript() {
        return BookConfig.epubInjectJavascript;
    }
    
    public final void injectJavascriptToEpubChapter(@NotNull final String filePath) {
        ...
        if (file.exists()) {
            ...
            if (StringsKt.indexOf$default((CharSequence)content, BookConfig.javascriptVersion, 0, false, 6, (Object)null) < 0) {
                content = StringsKt.replace$default(content, "<head>", "<head><script type=\"text/javascript\">" + BookConfig.epubInjectJavascript + "</script>", false, 4, (Object)null);
