...
{
    public ReplaceRuleController(@NotNull final CoroutineContext coroutineContext) {
    ...
    @Override
    public boolean checker(@NotNull final JsonObject var1, @NotNull final ReplaceRule var2) {
    ...
    @Nullable
    @Override
    public ReturnData beforeSave(@NotNull final ReplaceRule var1, @NotNull final DB<ReplaceRule> db) {
        Intrinsics.checkNotNullParameter((Object)var1, "var1");
    ...
    @Nullable
    @Override
    public ReturnData beforeAdd(@NotNull final ReplaceRule val1, @NotNull final DB<ReplaceRule> db) {
        return DefaultImpls.beforeAdd(this, val1, db);
    }
    
    @Nullable
    @Override
    public ReturnData beforeDelete(@NotNull final ReplaceRule val1, @NotNull final DB<ReplaceRule> db) {
        return DefaultImpls.beforeDelete(this, val1, db);
    }
    
    @NotNull
    @Override
    public ReplaceRule convertToEntity(@NotNull final JsonObject var1) {
        return DefaultImpls.convertToEntity((CURD<ReplaceRule>)this, var1);
    }
    
    @NotNull
    @Override
    public ReplaceRule[] convertToEntityList(@NotNull final String var1) {
        return DefaultImpls.convertToEntityList((CURD<ReplaceRule>)this, var1);
    }
    
    @Override
    public void onCheckEnd(@NotNull final ReplaceRule var1, final boolean var2, @NotNull final JsonArray var3) {
