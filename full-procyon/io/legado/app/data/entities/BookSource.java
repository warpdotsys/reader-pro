...
public final class BookSource implements BaseSource
{
    ...
    public final SearchRule getSearchRule() {
        ...
        return (ruleSearch == null) ? new SearchRule(null, null, null, null, null, null, null, null, null, null, 1023, null) : ruleSearch;
    }
    
    @NotNull
    public final ExploreRule getExploreRule() {
        final ExploreRule ruleExplore = this.ruleExplore;
        return (ruleExplore == null) ? new ExploreRule(null, null, null, null, null, null, null, null, null, null, 1023, null) : ruleExplore;
    }
    
    @NotNull
    public final BookInfoRule getBookInfoRule() {
        final BookInfoRule ruleBookInfo = this.ruleBookInfo;
        return (ruleBookInfo == null) ? new BookInfoRule(null, null, null, null, null, null, null, null, null, null, null, 2047, null) : ruleBookInfo;
    }
    
    @NotNull
    public final TocRule getTocRule() {
        final TocRule ruleToc = this.ruleToc;
        return (ruleToc == null) ? new TocRule(null, null, null, null, null, null, null, null, 255, null) : ruleToc;
    }
    
    @NotNull
    public final ContentRule getContentRule() {
        final ContentRule ruleContent = this.ruleContent;
        return (ruleContent == null) ? new ContentRule(null, null, null, null, null, null, 63, null) : ruleContent;
    }
