...
public final class BookList
{
    ...
    private final Object getSearchItem(final Object item, final AnalyzeRule analyzeRule, final BookSource bookSource, final String baseUrl, final String variable, final boolean log, final List<AnalyzeRule.SourceRule> ruleName, final List<AnalyzeRule.SourceRule> ruleBookUrl, final List<AnalyzeRule.SourceRule> ruleAuthor, final List<AnalyzeRule.SourceRule> ruleKind, final List<AnalyzeRule.SourceRule> ruleCoverUrl, final List<AnalyzeRule.SourceRule> ruleWordCount, final List<AnalyzeRule.SourceRule> ruleIntro, final List<AnalyzeRule.SourceRule> ruleLastChapter, final DebugLog debugLog, final Continuation<? super SearchBook> $completion) {
        final SearchBook searchBook = new SearchBook(null, null, null, 0, null, null, null, null, null, null, null, null, 0L, variable, 0, 24575, null);
        ...
        if (log) {
            if (debugLog != null) {
                DebugLog.DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("\u2514", (Object)searchBook.getName()), false, 4, null);
            }
        }
        if (searchBook.getName().length() > 0) {
            ...
            if (log) {
                if (debugLog != null) {
                    DebugLog.DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("\u2514", (Object)searchBook.getAuthor()), false, 4, null);
                }
            }
            JobKt.ensureActive($completion.getContext());
            if (log) {
            ...
            try {
                ...
                if (log) {
                    if (debugLog != null) {
                        DebugLog.DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("\u2514", (Object)searchBook.getKind()), false, 4, null);
                    }
                }
            }
            ...
            try {
                ...
                if (log) {
                    if (debugLog != null) {
                        DebugLog.DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("\u2514", (Object)searchBook.getWordCount()), false, 4, null);
                    }
                }
            }
            catch (final Exception e) {
            ...
            try {
                ...
                if (log) {
                    if (debugLog != null) {
                        DebugLog.DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("\u2514", (Object)searchBook.getLatestChapterTitle()), false, 4, null);
                    }
                }
            }
            catch (final Exception e) {
            ...
            try {
                ...
                if (log) {
                    if (debugLog != null) {
                        DebugLog.DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("\u2514", (Object)searchBook.getIntro()), false, 4, null);
                    }
                }
            }
            catch (final Exception e) {
            ...
            try {
                ...
                if (log) {
                    if (debugLog != null) {
                        DebugLog.DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("\u2514", (Object)searchBook.getCoverUrl()), false, 4, null);
                    }
                }
            }
            catch (final Exception e) {
            ...
            if (log) {
                if (debugLog != null) {
                    DebugLog.DefaultImpls.log$default(debugLog, bookSource.getBookSourceUrl(), Intrinsics.stringPlus("\u2514", (Object)searchBook.getBookUrl()), false, 4, null);
                }
            }
            return searchBook;
        }
