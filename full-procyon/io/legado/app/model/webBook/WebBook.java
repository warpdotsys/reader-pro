    ...
    public final Object exploreBook(@NotNull final String url, @Nullable final Integer page, @NotNull final Continuation<? super List<SearchBook>> $completion) {
        ...
        switch (((WebBook$exploreBook.WebBook$exploreBook$1)$continuation).label) {
            case 0: {
                ...
                analyzeUrl = new AnalyzeUrl(url, null, page, null, null, this.getBookSource().getBookSourceUrl(), this.getBookSource(), variableBook, null, this.getBookSource().getHeaderMap(true), this.getDebugger(), 282, null);
                ...
                switch (((WebBook$getBookInfo.WebBook$getBookInfo$1)$continuation).label) {
                    case 0: {
                        ...
                        if (charSequence != null && charSequence.length() != 0) {
                            ...
                            analyzeUrl = new AnalyzeUrl(book.getBookUrl(), null, null, null, null, this.getBookSource().getBookSourceUrl(), this.getBookSource(), book, null, this.getBookSource().getHeaderMap(true), this.getDebugger(), 286, null);
                            res = (Ref$ObjectRef)(l$4 = new Ref$ObjectRef());
                            final AnalyzeUrl analyzeUrl2 = analyzeUrl;
                            final String s = null;
                            final String s2 = null;
        ...
        Label_0420: {
            ...
            switch (((WebBook$getChapterList.WebBook$getChapterList$1)$continuation).label) {
                case 0: {
                    ...
                    analyzeUrl = new AnalyzeUrl(book.getTocUrl(), null, null, null, null, book.getBookUrl(), this.getBookSource(), book, null, this.getBookSource().getHeaderMap(true), this.getDebugger(), 286, null);
                    res = (Ref$ObjectRef)(l$4 = new Ref$ObjectRef());
                    final AnalyzeUrl analyzeUrl2 = analyzeUrl;
                    final String s = null;
                    final String s2 = null;
        ...
        switch (((WebBook$getBookContent.WebBook$getBookContent$1)$continuation).label) {
            case 0: {
                ...
                if (charSequence == null || charSequence.length() == 0) {
                    final DebugLog debugger = this.getDebugger();
                    if (debugger != null) {
                        DebugLog.DefaultImpls.log$default(debugger, this.getBookSource().getBookSourceUrl(), Intrinsics.stringPlus("\u21d2\u6b63\u6587\u89c4\u5219\u4e3a\u7a7a,\u4f7f\u7528\u7ae0\u8282\u94fe\u63a5: ", (Object)bookChapter.getUrl()), false, 4, null);
                    }
                ...
                if (bookChapter.isVolume() && StringsKt.startsWith$default(bookChapter.getUrl(), bookChapter.getTitle(), false, 2, (Object)null)) {
                    ...
                    if (debugger2 != null) {
                        DebugLog.DefaultImpls.log$default(debugger2, this.getBookSource().getBookSourceUrl(), "\u21d2\u4e00\u7ea7\u76ee\u5f55\u6b63\u6587\u4e0d\u89e3\u6790\u89c4\u5219", false, 4, null);
                    }
                ...
                final AnalyzeUrl analyzeUrl = analyzeUrl2 = new AnalyzeUrl(bookChapter.getAbsoluteURL(), null, null, null, null, book.getTocUrl(), this.getBookSource(), book, bookChapter, this.getBookSource().getHeaderMap(true), this.getDebugger(), 30, null);
