...
public final class BookHelp
{
    ...
    public final File getBookCacheDir(@NotNull final Book book) {
        ...
        final File localCacheDir = FileExtensionsKt.getFile(new File(bookDir), md5Encode);
    ...
    public final String getContent(@NotNull final Book book, @NotNull final BookChapter bookChapter) {
        ...
        final File file = FileExtensionsKt.getFile(bookCacheDir, subDirFiles);
        if (file.exists()) {
                ...
                switch (((BookHelp$saveImage.BookHelp$saveImage$1)$continuation).label) {
                    ...
                    case 2: {
                        Label_0307: {
                            ...
                            final AnalyzeUrl analyzeUrl = new AnalyzeUrl(src, null, null, null, null, null, bookSource, null, null, null, null, 1982, null);
                            try {
