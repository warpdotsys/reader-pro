...
public final class ExploreRule
implements BookListRule {
    ...
    public /* synthetic */ ExploreRule(String string, String string2, String string3, String string4, String string5, String string6, String string7, String string8, String string9, String string10, int n, DefaultConstructorMarker defaultConstructorMarker) {
        if ((n & 1) != 0) {
            string = null;
        }
        if ((n & 2) != 0) {
    ...
    public static /* synthetic */ ExploreRule copy$default(ExploreRule exploreRule, String string, String string2, String string3, String string4, String string5, String string6, String string7, String string8, String string9, String string10, int n, Object object) {
        if ((n & 1) != 0) {
            string = exploreRule.getBookList();
        }
        if ((n & 2) != 0) {
            string2 = exploreRule.getName();
        }
        if ((n & 4) != 0) {
            string3 = exploreRule.getAuthor();
        }
        if ((n & 8) != 0) {
            string4 = exploreRule.getIntro();
        }
        if ((n & 0x10) != 0) {
            string5 = exploreRule.getKind();
        }
        if ((n & 0x20) != 0) {
            string6 = exploreRule.getLastChapter();
        }
        if ((n & 0x40) != 0) {
            string7 = exploreRule.getUpdateTime();
        }
        if ((n & 0x80) != 0) {
            string8 = exploreRule.getBookUrl();
        }
        if ((n & 0x100) != 0) {
            string9 = exploreRule.getCoverUrl();
        }
        if ((n & 0x200) != 0) {
            string10 = exploreRule.getWordCount();
        }
        return exploreRule.copy(string, string2, string3, string4, string5, string6, string7, string8, string9, string10);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!Intrinsics.areEqual((Object)this.getBookList(), (Object)exploreRule.getBookList())) {
            return false;
        }
        if (!Intrinsics.areEqual((Object)this.getName(), (Object)exploreRule.getName())) {
            return false;
        }
        if (!Intrinsics.areEqual((Object)this.getAuthor(), (Object)exploreRule.getAuthor())) {
            return false;
        }
        if (!Intrinsics.areEqual((Object)this.getIntro(), (Object)exploreRule.getIntro())) {
            return false;
        }
        if (!Intrinsics.areEqual((Object)this.getKind(), (Object)exploreRule.getKind())) {
            return false;
        }
        if (!Intrinsics.areEqual((Object)this.getLastChapter(), (Object)exploreRule.getLastChapter())) {
            return false;
        }
        if (!Intrinsics.areEqual((Object)this.getUpdateTime(), (Object)exploreRule.getUpdateTime())) {
            return false;
        }
        if (!Intrinsics.areEqual((Object)this.getBookUrl(), (Object)exploreRule.getBookUrl())) {
            return false;
        }
        if (!Intrinsics.areEqual((Object)this.getCoverUrl(), (Object)exploreRule.getCoverUrl())) {
            return false;
        }
        return Intrinsics.areEqual((Object)this.getWordCount(), (Object)exploreRule.getWordCount());
    }
